...
public class PlayTestResultPublisher extends Publisher {
    ...
    public PlayTestResultPublisher(String name) {
        this.name = name;
    }
    ...
    public boolean perform(AbstractBuild build, Launcher launcher, BuildListener listener) {
        ...
        if(getDescriptor().usePlay) listener.getLogger().println("It's usePlay play auto-test");
        
        try {
			Process ps = Runtime.getRuntime().exec("test test-result/result.passed");
...
//				new FilePath(file).copyTo(target);
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Publisher> {
        ...
        public boolean configure(StaplerRequest req, JSONObject formData) throws FormException {
            ...
            usePlay = formData.getBoolean("usePlay");
