 ...
 *
 */
public class Play23x extends PlayVersion {
	...
	@Extension
    public static class Play23xDescriptor extends PlayVersionDescriptor {

		public static final String VERSION_ID = "PLAY_23X";
